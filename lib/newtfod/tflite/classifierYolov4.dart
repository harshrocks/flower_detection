...
import 'package:smokequit/newtfod/tflite/recognition.dart';
import 'package:tflite_flutter/tflite_flutter.dart';
import 'package:tflite_flutter_helper_plus/tflite_flutter_helper_plus.dart';
import 'package:tflite_flutter_plus/tflite_flutter_plus.dart' as tfl show TfLiteType;
...
class Classifier {
  ...
  static const String MODEL_FILE_NAME = "assets/hope.tflite";
  ...
  void loadModel({Interpreter? interpreter}) async {
    try {
      ...
      outputTensors.forEach((tensor) {
        ...
        _outputTypes!.add(tfl.TfLiteType.float32 as TfLiteType);
      });
    } catch (e) {
  ...
  Map<String, dynamic>? predict(imageLib.Image image) {
    ...
    TensorImage original = TensorImage(tfl.TfLiteType.float32);
