...
// import 'package:smokequit/tflite/recognition.dart';
...
import 'package:tflite_flutter_helper_plus/tflite_flutter_helper_plus.dart';
import 'stats.dart';
import 'package:tflite_flutter_plus/tflite_flutter_plus.dart' as tf show TfLiteType;
...
class Classifier {
  ...
  static const String MODEL_FILE_NAME = "hope.tflite";
  static const String LABEL_FILE_NAME = "labelss.txt";
  ...
  Map<String, dynamic>? predict(imageLib.Image image) {
    ...
    TensorImage inputImage1 = TensorImage(tf.TfLiteType.float32);
    inputImage1.loadImage(image);
    TensorImage inputImage = TensorImage.fromImage(image);
    ...
    // Maximum number of results to show
    int resultsCount = min(NUM_RESULTS, numLocations1.getIntValue(0));
    print(resultsCount);
